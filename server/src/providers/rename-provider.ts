...
import { getDefinitions, getReferences, isDefinition, symbolAtPosition } from '../symbols';
...
export default class RenameProvider implements Provider {
	...
	async onPrepareRename({
		...
		return isDefinition(foundSymbol) ? foundSymbol.selectionRange : foundSymbol.location.range;
	}
